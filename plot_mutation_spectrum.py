...
def main():
    ...
    parser.add_argument("-v", "--vcf_file_folder", help="path to folder containing small variant VCF files")
    parser.add_argument("-n", "--name", help="string to associate with the files/figures", default="mut_spec")
    parser.add_argument("-r", "--reference", help="Must be one of GRCh38,GRCh37,mm10,mm9,etc.", default="GRCh37")
    ...
    matGen.SigProfilerMatrixGeneratorFunc(args.name, args.reference, args.vcf_file_folder, plot=True)
